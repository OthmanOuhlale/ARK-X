...
const rlCities = readline.createInterface(
...
function getName(){
    rlCities.question('Name of city: ', (city) => {
...
//     const data = await response.json();
//     // console.log(data);
//     console.log('Temperature of the ' + foundCity.name  + ' is: '+ data.current_weather.temperature);
// }
